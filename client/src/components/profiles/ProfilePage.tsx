...
import { Block, BlockInput, EmbeddedUserList, MalLinkOauthDocument, MalLinkOauthQuery, ProfileDocument, useUpdateProfilePageBlocksMutation } from "../../generated/graphql";
