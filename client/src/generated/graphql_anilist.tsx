...
export type FetchAnimeInfoQueryVariables = Exact<{
...
/**
 * __useFetchAnimeInfoQuery__
 *
 * To run a query within a React component, call `useFetchAnimeInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchAnimeInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchAnimeInfoQuery({
 *   variables: {
 *      ids: // value for 'ids'
 *   },
 * });
 */
export function useFetchAnimeInfoQuery(baseOptions: Apollo.QueryHookOptions<FetchAnimeInfoQuery, FetchAnimeInfoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchAnimeInfoQuery, FetchAnimeInfoQueryVariables>(FetchAnimeInfoDocument, options);
      }
export function useFetchAnimeInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchAnimeInfoQuery, FetchAnimeInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchAnimeInfoQuery, FetchAnimeInfoQueryVariables>(FetchAnimeInfoDocument, options);
        }
